...
list_of_avds_raw = subprocess.Popen(
    "emulator -list-avds", shell=True, stdout=subprocess.PIPE, universal_newlines=True
).communicate()[0]


list_of_avds = list_of_avds_raw.splitlines()

emulator_location_raw = subprocess.Popen(
    "where emulator", shell=True, stdout=subprocess.PIPE, universal_newlines=True
).communicate()[0]
