...
# using IMAP protocol
def check_latest_received_email(imap_host,imap_user,imap_pass,select_mailbox):
...
if __name__ == "__main__":
    ...
    check_latest_received_email(imap_host,imap_user,imap_pass,select_mailbox)