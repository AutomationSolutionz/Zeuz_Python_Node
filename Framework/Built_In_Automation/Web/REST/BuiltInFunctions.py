...
def rest_demo():
    dataset = [
        [
            ['method','element parameter','post',False,False],
            ['url', 'element parameter', 'https://pdm-qa.asci.io/api/login', False, False],
            ['username', 'body', 'automationpdm', False, False],
            ['password', 'body', 'Password1!', False, False],
            ['save response', 'action', 'all', False, False]
        ],
        [
            ['method','element parameter','post',False,False],
            ['url', 'element parameter', 'https://pdm.asci.io/oauth/access_token?grant_type=refresh_token&refresh_token=%|refresh_token|%', False, False],
            ['save response', 'action', 'access_token', False, False]
        ],
        [
            ['method', 'element parameter', 'post', False, False],
            ['url', 'element parameter', 'https://pdm-qa.asci.io/api/sessions', False, False],
            ['Authorization','headers', 'Bearer %|access_token|%', False, False],
            ['Content-Type', 'headers', 'application/json', False, False],
            ['pairingCode', 'body', '%|random_string()|%', False, False],
            ['save response', 'action', 'id, pairingCode, iosDownloadUrl', False, False]
        ],
        [
            ['method', 'element parameter', 'put', False, False],
            ['url', 'element parameter', 'https://pdm-qa.asci.io/api/sessions/%|id|%', False, False],
            ['Authorization', 'headers', 'Bearer %|access_token|%', False, False],
            ['Content-Type', 'headers', 'application/json', False, False],
            ['status', 'body', 'closed', False, False],
            ['save response', 'action', 'none', False, False]
        ],
        [
            ['%|username|%', 'compare', 'automationpdm', False, False],
            ['%|token_type|%', 'compare', 'Bearer', False, False],
            ['%|expires_in|%', 'compare', '3600', False, False],
            ['compare variable','action','compare',False,False]
        ]
...
def var_share_demo():
    dataset = [
        [
            ['initialize list', 'action', 'list1', False, False]
        ],
        [
            ['initialize list', 'action', 'list2', False, False]
        ],
        [
            ['method','element parameter','post',False,False],
            ['url', 'element parameter', 'https://pdm-qa.asci.io/api/login', False, False],
            ['username', 'body', 'automationpdm', False, False],
            ['password', 'body', 'Password1!', False, False],
            ['insert into list: list1', 'action', 'all', False, False]
        ],
        [
            ['method', 'element parameter', 'post', False, False],
            ['url', 'element parameter', 'https://pdm-qa.asci.io/api/login', False, False],
            ['username', 'body', 'automationpdm', False, False],
            ['password', 'body', 'Password1!', False, False],
            ['insert into list: list2', 'action', 'all', False, False]
        ],
        [
            ['method', 'element parameter', 'post', False, False],
            ['url', 'element parameter', 'https://pdm-qa.asci.io/api/login', False, False],
        ...
        [
            ['list1','compare','list2', False, False],
            ['compare list','action','compare',False,False]
        ]
