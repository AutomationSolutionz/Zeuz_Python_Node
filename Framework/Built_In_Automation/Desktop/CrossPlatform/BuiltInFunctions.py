...
from Framework.Built_In_Automation.Desktop.RecordPlayback.ChoosePlaybackModuleV2 import ChoosePlaybackModuleV2
...
@logger
def playback_recorded_events_v2(data_set):
    """Plays back the recorded events from a given file."""
    ...
    try:
        ...
        playback_chooser = ChoosePlaybackModuleV2(filepath)
        playback_chooser.play(speed_factor=speed_factor)
