...
def search_an_item_on_amazon(dependency, run_time_params, step_data, file_attachment, temp_q, screen_capture, device_info):
    ...
    try:
        CommonUtil.ExecLog(
            sModuleInfo, "Enter: Step - Search an Item on Amazon", 1)
        ...
        if sTestStepReturnStatus in passed_tag_list:
            CommonUtil.ExecLog(
                sModuleInfo, "Successfully searched an item on Amazon", 1)
            temp_q.put(sTestStepReturnStatus)
            CommonUtil.ExecLog(
                sModuleInfo, "Exit: Step - Search an item on Amazon", 1)
            return sTestStepReturnStatus

        elif sTestStepReturnStatus in failed_tag_list:
            CommonUtil.ExecLog(
                sModuleInfo, "Unable to search an item on Amazon", 3)
            temp_q.put(sTestStepReturnStatus)
            CommonUtil.ExecLog(
                sModuleInfo, "Exit: Step - Search an item on Amazon", 1)
            return sTestStepReturnStatus
            ...
            CommonUtil.ExecLog(sModuleInfo, "Step return type unknown: %s" % (
...
def add_an_item_to_cart_on_amazon(dependency, run_time_params, step_data, file_attachment, temp_q, screen_capture, device_info):
    ...
    try:
        CommonUtil.ExecLog(
            sModuleInfo, "Enter: Step - Add an Item to Cart on Amazon", 1)
        search_text = step_data[0][0][2]
        sTestStepReturnStatus = Amazon.Add_to_Cart(search_text)

        if sTestStepReturnStatus in passed_tag_list:
            CommonUtil.ExecLog(
                sModuleInfo, "Successfully Added an Item to Cart on Amazon", 1)
            temp_q.put(sTestStepReturnStatus)
            CommonUtil.ExecLog(
            ...
            CommonUtil.ExecLog(
                sModuleInfo, "Unable to add an item on Amazon", 3)
            temp_q.put(sTestStepReturnStatus)
            CommonUtil.ExecLog(
                sModuleInfo, "Exit: Step - Add an Item to Cart on Amazon", 1)
            return sTestStepReturnStatus
...
def add_an_item_to_cart_on_amazon_using_selenium(dependency, run_time_params, step_data, file_attachment, temp_q, screen_capture, device_info):
    ...
    try:
        CommonUtil.ExecLog(
            sModuleInfo, "Enter: Step - Add an Item to Cart on Amazon Using Selenium", 1)
        ...
        if sTestStepReturnStatus in passed_tag_list:
            ...
            temp_q.put(sTestStepReturnStatus)
            CommonUtil.ExecLog(
                sModuleInfo, "Exit: Step - Add an Item to Cart on Amazon Using Selenium", 1)
            return sTestStepReturnStatus
