...
class MyDialogBox:
    def __init__(self, root):
        self.UPDATE_MSG = (
            "A Zeuz Node update is available. Do you want to download and install it?"
        )
        ...
        # print(a)
        Label(top, text=self.UPDATE_MSG).grid(
            row=0, column=0, rowspan=2, columnspan=10, padx=20, pady=20
        )
    ...
    def yesf(self):
        ...
        self.root.after(
            10000, self.root.check_for_updates
