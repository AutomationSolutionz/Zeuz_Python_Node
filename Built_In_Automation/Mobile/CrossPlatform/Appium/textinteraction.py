...
def set_text_by_id(driver, _id, text, parent=False):
...
def set_text_by_name(driver, _name, text, parent=False):
    sModuleInfo = inspect.stack()[0][3] + " : " + inspect.getmoduleinfo(__file__).name
    try:
...
def set_text_by_class_name(driver, _class, text, parent=False):
    sModuleInfo = inspect.stack()[0][3] + " : " + inspect.getmoduleinfo(__file__).name
    try:
...
def set_text_by_xpath(driver, _classpath, text, parent=False):
    sModuleInfo = inspect.stack()[0][3] + " : " + inspect.getmoduleinfo(__file__).name
    try:
...
def set_text_by_accessibility_id(driver, _id, text, parent=False):
    sModuleInfo = inspect.stack()[0][3] + " : " + inspect.getmoduleinfo(__file__).name
    try:
